...
- [ ] #264 A meal decline must not delete logged food (PR #282: rebase, then merge; round-5 finding is #291)
- [ ] #291 Multi-word negated food in a correction (follow-up from #282)
...
- [ ] #292 Coach Health scores every live turn, daily tester digest
