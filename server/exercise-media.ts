...
const EXERCISE_SLUGS: Record<string, string> = {
  ...
  // ── Bare singulars & machine synonyms clients LOG lifts with ─────
  // Progressive-overload tracking groups by canonical slug, so "chest fly",
  // "pec deck" and "cable fly" must all land on chest-fly or the same lift
  // fragments into three untracked ones. (Machine chest press vs barbell bench
  // stay separate — genuinely different loads.)
  "chest fly":                        "chest-fly",
  ...
  "cable fly":                        "chest-fly",
  "cable flys":                       "chest-fly",
  "cable flyes":                      "chest-fly",
