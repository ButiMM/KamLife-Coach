    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-neutral max-w-none space-y-10 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">4. Subscription and payment</h2>
            <ul className="space-y-2 list-disc pl-5 text-muted-foreground">
              <li>The subscription fee is <strong>{PRICE} per month</strong>, billed monthly and <strong>paid upfront</strong>. There is no trial period.</li>
              <li>Your first payment is covered by a <strong>14-day money-back guarantee</strong>: ask within 14 days and we refund it in full, no reason required. See the <Link href="/cancellation" className="text-primary underline">Refund &amp; Cancellation Policy</Link>.</li>
              <li>Payment is processed via <strong>PayFast</strong>. We do not store your card or banking details.</li>
              <li>Your subscription renews automatically each month on the same date as your first payment, unless you cancel.</li>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">5. Cancellation</h2>
            <ul className="space-y-2 list-disc pl-5 text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">11. Governing law and disputes</h2>
