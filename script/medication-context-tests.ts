...
import { detectMedicationContext } from "../server/safety-detection";

const contextOnly = detectMedicationContext("I'm taking Ozempic and I'm working on my food.");
...
assert.equal(dosing.medicationClass, "glp1");
...
const benign = detectMedicationContext("I had eggs and pap today.");
